...
const SvgHand = (style) => {
    return (
        <View style={style}>
            <Svg  width="17.724" height="25.855" viewBox="0 0 13.724 15.855">
    ...
    return (
        <SafeAreaView style={{ alignSelf: 'center', width: layout.screenWidth.medium, flexGrow: 1, flexDirection: 'column' }}>
            <View style={{ aspectRatio: 945 / 15, height: layout.screenWidth.xxxSmall, alignSelf: 'center' }}>
                <Image style={{ flex: 1, width: null, height: null }} source={StepOne} resizeMode='stretch' />
            </View>
            ...
            <View style={{ flex: 6, alignItems: 'center', paddingTop: layout.padding.xxxxLarge }}>
                ...
                <View style={{ height: layout.autoImageSizes.large, aspectRatio: 696 / 631 }} >
                    <Image source={girlImagePath} style={{ flex: 1, height: null, width: null }} resizeMode='stretch' />
                </View>
                <Text style={{ top: -5, padding: layout.padding.medium, alignSelf: 'center', color: colors.themeColors.primary, fontSize: layout.fontSizes.medium, fontFamily: 'Nunito-SemiBold', }}>{goalDescription}</Text>
            </View>
            <TextInput onChangeText={text => onChangeGoal(text)} value={goal} style={{ flex:0.6, color: colors.themeColors.primary, fontSize: layout.fontSizes.medium, borderBottomWidth: 1, borderBottomColor:colors.themeColors.primary, }} placeholder={goalPlaceholder} textContentType='nickname' />
            <View style={{ flex: 1, paddingTop: layout.padding.large }}>
                < SvgHand style={{aspectRatio:13.724/15.855, width: 150}} />
            ...
            <View style={{ flex: 5, alignItems: 'center', paddingTop: layout.padding.xxxxLarge }}>
