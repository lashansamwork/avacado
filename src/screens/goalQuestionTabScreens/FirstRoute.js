        ...
        <SafeAreaView style={{ flexGrow: 1, marginTop: SAFEVIEW_OFFSET}}>
            <View style={{ flex: 1, paddingHorizontal: layout.padding.screenHorizontal }}>
                ...
                <View style={{ flex: 2, justifyContent: 'center', alignItems: 'center' }}>
                    ...
                    <Text style={{ paddingTop: layout.padding.small, fontFamily: layout.fonts.nunito, fontSize: layout.fontSizes.medium, color:colors.themeColors.primary }}>{goalDescription}</Text>
                    <View style={{ flexBasis: IMAGE_OFFSET }}></View>
                </View>
            </View>
            <View style={{ flex: 1, paddingHorizontal: layout.padding.screenHorizontal }}>
                <View style={{ flex: 8, }}>
                    <CustomTextInput style={{ position: 'absolute', bottom: 0, width: '100%' }} gap={CUSTOM_INPUT_TEXT_GAP} placeholder={readingGirlPlaceholder} value={goal} onChangeText={text => onChangeGoal(text)} />
                </View>
                <View style={{ flex: 11 }}>
                    <View style={{ flexBasis:8}}></View>
                    < SvgHand style={{ aspectRatio: layout.imageAspectRatio.svgHand, }} />
                    <Text style={{ flex: 1, color: colors.themeColors.pink, fontSize: layout.fontSizes.small }}>{`Goals must be Specific, Measurement, Achievable, \nRelevant and Time based.`}</Text>
                </View>
                <View style={{ flex: 26 }}>
