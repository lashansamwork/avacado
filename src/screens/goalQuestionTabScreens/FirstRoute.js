...
const FirstRoute = (onPress) => {
    ...
    return (
        <SafeAreaView style={{ alignSelf: 'center', width: layout.screenWidth.medium, flexGrow: 1, flexDirection: 'column'}}>
            ...
            <TextInput onChangeText={text => onChangeGoal(text)} value={goal} style={{ flex: 0.5, width: '100%', height: 40, borderBottomColor: colors.themeColors.primary, borderBottomWidth: 1, fontFamily: 'Nunito-SemiBold' }} placeholder={goalPlaceholder} fontSize={layout.fontSizes.small} textContentType='nickname' />
