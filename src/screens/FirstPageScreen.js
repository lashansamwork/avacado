...
const FirstPageScreen = ({navigation}) => {
    ...
    return (
        <View style={{flex:1}}>
            ...
            <TextInput placeholder="What do you want me to call you?"  textContentType='nickname' style={{flex:0.5, alignSelf:'center',width:'70%',height: 40,borderBottomColor:"#1C4950", borderBottomWidth: 1}} onChangeText={text => onChangeText(text)} value={value} />
