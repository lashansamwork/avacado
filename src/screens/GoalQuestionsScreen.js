...
const FirstRoute = () => {
    ...
    return (<SafeAreaView style={{ alignSelf: 'center', width: layout.screenWidth.medium, flexGrow: 1, }}>
        <View style={{ flex: 2, alignItems: 'center', justifyContent: 'center', }}>
            <Image style={{ width: layout.autoImageSizes.large }} source={StepOne} resizeMode='contain' />
        </View>
        ...
        <TextInput onChangeText={text => onChangeGoal(text)} value={goal} style={{ flex: 0.5, width: '100%', height: 40, borderBottomColor: colors.themeColors.primary, borderBottomWidth: 1, fontFamily: 'Nunito-SemiBold' }} placeholder="Get my bachelors degree in three years" fontSize={layout.fontSizes.small} textContentType='nickname' />
        ...
        <View style={{ flex: 5, alignItems: 'center', paddingTop: layout.padding.xxxLarge }}>
            <TouchableOpacity onPress={(e) => { setIndex(1) }}>
                <CheckCircle />
            </TouchableOpacity>
        </View>
    </SafeAreaView>);
...
const SecondRoute = () => {
    ...
    <SafeAreaView style={{ alignSelf: 'center', width: layout.screenWidth.medium, flexGrow: 1, }}>
        ...
        <TextInput style={{ flex: 0.5, width: '100%', height: 40, borderBottomColor: colors.themeColors.primary, borderBottomWidth: 1, fontFamily: 'Nunito-SemiBold' }} placeholder="Get my bachelors degree in three years" fontSize={layout.fontSizes.small} textContentType='nickname' onChangeText={text => onChangeReason(text)} value={reason} />
        <View style={{ flex: 1, paddingTop: layout.padding.large }}>
            < SvgHand />
