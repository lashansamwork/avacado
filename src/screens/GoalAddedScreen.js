        ...
        <SafeAreaView style={{ flexGrow: 1, justifyContent: 'space-evenly', alignItems: 'center' }}>
            ...
            <TouchableOpacity style={{ flex: 1, alignItems: 'center' }}>
                ...
                <View style={{ aspectRatio: 998 / 928, height: layout.heights.medium }}>
                    <Image style={{ flex: 1, width: null, height: null, }} source={CongratzHand} resizeMode="stretch" />
                </View> 
                <View style={{ flex:3, justifyContent: 'center', alignItems:'center', width:layout.screenWidth.medium}}>
                    <Text style={{ flexShrink: 1, textAlign:'center',fontFamily: "Nunito-SemiBold", color: colors.themeColors.pink, fontSize: layout.fontSizes.xxxLarge }}>Congrats Layan!</Text>
                    <Text style={{ flexShrink: 1, textAlign:'center',fontFamily: "Nunito-SemiBold",fontSize: layout.fontSizes.large, color: colors.themeColors.primary,    }}>You added a new goal that will change your life journey!</Text>      
                </View>
            </TouchableOpacity>
        </SafeAreaView>
    );
